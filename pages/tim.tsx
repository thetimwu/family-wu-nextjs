        ...
        <div className="w-4/12 sm:w-2/12 bg-white p-3 shadow-lg">
          ...
          <ul className="space-y-2 text-sm">
            <li>
              <a
                href="#"
                className="flex items-center  text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 bg-gray-200 focus:shadow-outline"
              >
            ...
            <li>
              <a
                href="#"
                className="flex items-center text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 focus:bg-gray-200 focus:shadow-outline"
              >
                <div className="block md:flex md:space-x-3">
                  <span className="text-gray-600">
                    <svg
